#
#  Be sure to run `pod spec lint ElitechToolSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "FYM" => "1024799300@qq.com" }
  # Or just: spec.author    = "FYM"
  # spec.authors            = { "FYM" => "1024799300@qq.com" }
  # spec.social_media_url   = "https://twitter.com/FYM"
  ...
  spec.source       = { :git => "https://github.com/DockLle/ElitechToolSDK.git", :tag => "#{spec.version}" }
  ...
  spec.resource_bundles = { 'ElitechPrivacyInfo' => ['ElitechToolSDK/Assets/PrivacyInfo.xcprivacy'] }
